 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | GUI  |  Alt | Func | Lower|    Space    | Raise| Left | Down |  Up  | Right|
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_mit(
    ...
    KC_LCTL, KC_LGUI, KC_LALT, FUNC   , LOWER  , KC_SPC          , RAISE  , KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT 
),
 ...
 * |------+------+------+------+------+------+------+------+------+------+------|------+
 * |      |      |CV(LT)|CV(DN)|CV(RT)|      |      | Left | Down | Right|      |      |
 * |------+------+------+------+------+------+------+------+------+------+------|------+
 * |      |      |      |      |      |      |      | Home |      |  End |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------|------+
 * |      |      |      |      |      |             |      |      |      |      |      |
...
#ifdef AUDIO_ENABLE
float shot_timeout_song[][2] = SONG(E__NOTE(_E7), E__NOTE(_E6));
float layer1_shot_song[][2] = SONG(E__NOTE(_E6), E__NOTE(_E7));
